...
inline void MariadbClient::set_allocated_ip(::std::string* ip) {
  if (ip_ != &::google::protobuf::internal::kEmptyString) {
    delete ip_;
  }
  if (ip) {
...
inline void MariadbClient::set_allocated_user(::std::string* user) {
  if (user_ != &::google::protobuf::internal::kEmptyString) {
    delete user_;
  }
  if (user) {
...
inline void MariadbClient::set_allocated_password(::std::string* password) {
  if (password_ != &::google::protobuf::internal::kEmptyString) {
    delete password_;
  }
  if (password) {
...
inline void MariadbClient::set_allocated_db(::std::string* db) {
  if (db_ != &::google::protobuf::internal::kEmptyString) {
    delete db_;
  }
  if (db) {
