...
void protobuf_AssignDesc_OS_2eNetwork_2eproto() {
  ...
  static const int NetworkRoute_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(NetworkRoute, index_),
  };
  ...
  static const int NetworkInterface_offsets_[4] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(NetworkInterface, index_),
...
void protobuf_ShutdownFile_OS_2eNetwork_2eproto() {
  ...
  delete SSHTunnel::_default_local_ip_;
  delete SSHTunnel::_default_remote_user_;
...
void protobuf_AddDesc_OS_2eNetwork_2eproto() {
  ...
  SSHTunnel::_default_local_ip_ =
      new ::std::string("127.0.0.1", 9);
  SSHTunnel::_default_remote_user_ =
...
const int NetworkRoute::kIndexFieldNumber;
#endif  // !_MSC_VER
...
const NetworkRoute& NetworkRoute::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_OS_2eNetwork_2eproto();
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_route_ip:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->route_ip(this->route_ip_size() - 1).data(),
            this->route_ip(this->route_ip_size() - 1).length(),
...
#ifndef _MSC_VER
const int NetworkInterface::kIndexFieldNumber;
      ...
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_ip_cidr:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->ip_cidr(this->ip_cidr_size() - 1).data(),
            this->ip_cidr(this->ip_cidr_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
      ...
      case 6: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_dns_server:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->dns_server(this->dns_server_size() - 1).data(),
            this->dns_server(this->dns_server_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE);
        } else {
          goto handle_uninterpreted;
        }
...
::std::string* SSHTunnel::_default_local_ip_ = NULL;
::std::string* SSHTunnel::_default_remote_user_ = NULL;
#ifndef _MSC_VER
