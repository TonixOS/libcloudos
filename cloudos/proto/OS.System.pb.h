...
class System : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_root_password(::std::string* root_password);
  ...
  inline void set_allocated_keyboard_layout(::std::string* keyboard_layout);
  ...
  inline void set_allocated_locale_charset(::std::string* locale_charset);
...
inline void System::set_allocated_hostname(::std::string* hostname) {
  if (hostname_ != &::google::protobuf::internal::kEmptyString) {
    delete hostname_;
  }
  if (hostname) {
...
inline void System::set_allocated_root_password(::std::string* root_password) {
  if (root_password_ != &::google::protobuf::internal::kEmptyString) {
...
inline void System::set_allocated_keyboard_layout(::std::string* keyboard_layout) {
  if (keyboard_layout_ != &::google::protobuf::internal::kEmptyString) {
...
inline void System::set_allocated_locale_charset(::std::string* locale_charset) {
  if (locale_charset_ != &::google::protobuf::internal::kEmptyString) {
    delete locale_charset_;
  }
  if (locale_charset) {
    set_has_locale_charset();
    locale_charset_ = locale_charset;
  } else {
    clear_has_locale_charset();
    locale_charset_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
