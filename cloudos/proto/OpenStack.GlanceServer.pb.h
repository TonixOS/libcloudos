...
class GlanceServer : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_registry_host(::std::string* registry_host);
  ...
  inline void set_allocated_registry_client_protocol(::cloudos::config::os::WebProtocol* registry_client_protocol);
...
inline void GlanceServer::set_allocated_host(::std::string* host) {
  if (host_ != &::google::protobuf::internal::kEmptyString) {
    delete host_;
  }
  if (host) {
...
inline void GlanceServer::set_allocated_registry_host(::std::string* registry_host) {
  if (registry_host_ != &::google::protobuf::internal::kEmptyString) {
...
inline void GlanceServer::set_allocated_registry_client_protocol(::cloudos::config::os::WebProtocol* registry_client_protocol) {
  delete registry_client_protocol_;
  registry_client_protocol_ = registry_client_protocol;
...
inline void GlanceServer::set_allocated_ssl_settings(::cloudos::config::os::SSLSettings* ssl_settings) {
