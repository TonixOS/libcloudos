...
class NeutronServer : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_public_ip_pool(::std::string* public_ip_pool);
...
// optional string index = 2;
inline bool NeutronServer::has_index() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void NeutronServer::set_has_index() {
  _has_bits_[0] |= 0x00000001u;
}
inline void NeutronServer::clear_has_index() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void NeutronServer::clear_index() {
  if (index_ != &::google::protobuf::internal::kEmptyString) {
    index_->clear();
  }
  clear_has_index();
}
inline const ::std::string& NeutronServer::index() const {
  return *index_;
}
inline void NeutronServer::set_index(const ::std::string& value) {
  set_has_index();
  if (index_ == &::google::protobuf::internal::kEmptyString) {
...
inline void NeutronServer::set_index(const char* value) {
  set_has_index();
  if (index_ == &::google::protobuf::internal::kEmptyString) {
    index_ = new ::std::string;
  }
...
inline void NeutronServer::set_index(const char* value, size_t size) {
  set_has_index();
  if (index_ == &::google::protobuf::internal::kEmptyString) {
    index_ = new ::std::string;
  }
...
inline ::std::string* NeutronServer::mutable_index() {
  set_has_index();
  if (index_ == &::google::protobuf::internal::kEmptyString) {
    index_ = new ::std::string;
  }
...
inline ::std::string* NeutronServer::release_index() {
  clear_has_index();
  if (index_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void NeutronServer::set_allocated_index(::std::string* index) {
  if (index_ != &::google::protobuf::internal::kEmptyString) {
    delete index_;
  }
  if (index) {
...
inline void NeutronServer::set_allocated_public_ip_pool(::std::string* public_ip_pool) {
  if (public_ip_pool_ != &::google::protobuf::internal::kEmptyString) {
    delete public_ip_pool_;
  }
  if (public_ip_pool) {
    set_has_public_ip_pool();
    public_ip_pool_ = public_ip_pool;
  } else {
    clear_has_public_ip_pool();
    public_ip_pool_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
inline void NeutronServer::set_allocated_ssl_settings(::cloudos::config::os::SSLSettings* ssl_settings) {
