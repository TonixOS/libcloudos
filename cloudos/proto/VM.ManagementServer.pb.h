...
inline void ManagementServer::set_allocated_ip(::std::string* ip) {
  if (ip_ != &::google::protobuf::internal::kEmptyString) {
    delete ip_;
  }
  if (ip) {
...
inline void ManagementServer::set_allocated_secret_key(::std::string* secret_key) {
  if (secret_key_ != &::google::protobuf::internal::kEmptyString) {
    delete secret_key_;
  }
  if (secret_key) {
...
inline void ManagementServer::set_allocated_ssl_settings(::cloudos::config::os::SSLSettings* ssl_settings) {
